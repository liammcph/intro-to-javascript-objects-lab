...
game.party.push(pokemon.find(p => p.type === "fire"));
...
game.catchPokemon(pokemon.find(p => p.name === "Gengar"))
console.log(game.party);
...
const pokeballitem = game.items.find(p => p.name === "pokeball") 

game.catchPokemon = function catchPokemon(pokemonObj) {
  game.party.push(pokemonObj)
  pokeballitem.quantity = pokeballitem.quantity-1 
}

game.catchPokemon(pokemon.find(p => p.name === "Dragonair"))
console.log(game.party);
console.log(pokeballitem.quantity)
